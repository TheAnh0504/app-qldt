...
class ListAssignmentStudent extends ConsumerStatefulWidget {
  final ClassInfoModel infoClass;
  final List<SurveyModel> listSurveyModel;
  const ListAssignmentStudent({super.key, required this.infoClass, required this.listSurveyModel});

  @override
  ConsumerState<ListAssignmentStudent> createState() => _ListAssignmentStudent();
}

class _ListAssignmentStudent extends ConsumerState<ListAssignmentStudent> {
